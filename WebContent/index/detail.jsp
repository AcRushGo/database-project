...
<head>
    ...
    <script>
        function price() {
            ...
            x[0].getElementsByClassName("item_price")[0].innerText = price;

        }
    </script>
    <script>
        function price1() {
            var price = ${good.price1};
            var x = document.getElementsByClassName("prices");
            x[0].getElementsByClassName("item_price")[0].innerText = price;
        ...
        <div class="single-grids">
                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="../${good.cover}">
                            <div class="thumb-image"><img src="../${good.cover}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="../${good.image1}">
                            <div class="thumb-image"><img src="../${good.image1}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="../${good.image2}">
                            <div class="thumb-image"><img src="../${good.image2}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-4 single-grid simpleCart_shelfItem">
                ...
                <div class="btnguige">
                    <br/>
                    规格选择
                    <button onclick="price()">64G</button>
                    <button onclick="price1()">128G</button>
                </div>
